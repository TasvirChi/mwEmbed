	...
	$evaluates = array(
		...
		'mediaProxy.entry' => array(
			'desc' => "Return or set all entry properties. Entry properties include:
				...
				See Borhan <a target=\"_new\" href=\"http://www.borhan.com/api_v3/testmeDoc/?object=BorhanBaseEntry\">base entry object</a>,
				in Borhan API definition for full set of properties.",
		...
		'mediaProxy.entryCuePoints' => array(
			'desc' => 'Return or set cue points for the current media entry.
				See Borhan <a target=\"_new\" href=\"http://www.borhan.com/api_v3/testmeDoc/?object=BorhanCuePoint\">cuePoint object</a>,
				in Borhan API definition for full set of properties.',
			'example' => '../modules/BorhanSupport/tests/StandAlonePlayerMediaProxyOverride.html'
		),
		'mediaProxy.entryMetadata' => array(
			'desc' => 'Metadata object for the current entry. Enables reading custom metadata key value pairs.',
			'example' => '../modules/BorhanSupport/tests/CustomMetaData.html'
		),
		...
		'mediaProxy.borhanMediaFlavorArray' => array(
		...
		'playerStatusProxy.bdpStatus' => array(
