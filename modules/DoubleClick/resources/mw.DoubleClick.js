...
mw.DoubleClick.prototype = {
	...
	init: function( embedPlayer, callback, pluginName ){
		...
		this.loadIma( function(){
			...
			if( (_this.getConfig( "preSequence" ) || _this.getConfig( "postSequence" )) && _this.getConfig( "adTagUrl" ) ){
				...
				_this.addBorhanCuePointBindings();
			}
	...
	addBorhanCuePointBindings: function(){
		var _this = this;
		mw.log("DoubleClick::addBorhanCuePointBindings");
		// Add a binding for cuepoints:
		_this.embedPlayer.bindHelper( 'BorhanSupport_AdOpportunity' + _this.bindPostfix, function( event,  cuePointWrapper ){
			...
			if( adType == 'midroll' ){
				...
				mw.log( "DoubleClick:: addBorhanCuePointBindings: midroll -> requestAds" );
	...
	requestAds: function( adTagUrl, adType ) {
		...
		_this.embedPlayer.setBDPAttribute( this.pluginName, 'requestedAdTagUrl', adTagUrl );
