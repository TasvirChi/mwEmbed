...
return array (
	'widevine' => array(
	 	'description' => 'The Widevine plugin provides a DRM solution for Borhan content. Initially, the Borhan player checks for the Widevine browser plugin and displays a message with a download link if this plugin is missing. <a href="http://www.widevine.com/wv_drm.html" target="_blank"> More info </a>',
		'attributes' => array(
			...
			'useBdpMsg' => array(
				'label' => "Use BDP message",
				'doc' => "Overrides the message that prompts the user to use BDP.",
				'type' => 'hiddenValue',
				'initvalue' => "This video requires Adobe Flash enabled player."
			),
			'useBdpTitle' => array(
				'label' => "Use BDP title",
				'doc' => "Overrides the title of the message that prompts the user to use BDP.",
				'type' => 'hiddenValue',
				'initvalue' => "Notification"
			),
			'promptStyle' => array(
