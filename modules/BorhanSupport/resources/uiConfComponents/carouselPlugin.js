...
<Plugin id="related" path="http://projects.borhan.com/nu/wwwCoBSchool/plugins/relatedPlugin.swf"
...
embedPlayer.bindHelper( 'onpause' + _this.bindPostFix, function() {
		...
		addTitle: function() {
			...
			if ( embedPlayer.borhanPlayerMetaData ) {
				videoName = embedPlayer.borhanPlayerMetaData.name;
			}
...
buildCarousel: function() {
			...
			for ( var playlist_id in embedPlayer.borhanPlaylistData ) {
				entriesArray = $.merge( entriesArray, embedPlayer.borhanPlaylistData[ playlist_id ].items );
			}
