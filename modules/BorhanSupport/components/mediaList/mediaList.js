	...
	mw.PluginManager.add( 'mediaList', mw.KBaseComponent.extend( {
			...
			addMediaItem: function(obj ,index){
				...
				mediaItem = {
					...
					startTimeDisplay: this.formatTimeDisplayValue(bWidget.seconds2npt( obj.startTime / 1000 )),
					endTime: null,
			...
			setMediaItemTime: function(){
				...
				$.each(this.mediaList, function(index, item){
					...
					item.durationDisplay = bWidget.seconds2npt((item.endTime - item.startTime) );
				});
			},
