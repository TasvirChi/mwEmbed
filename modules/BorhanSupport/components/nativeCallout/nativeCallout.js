( function( mw, $ ) {"use strict";
	...
	mw.PluginManager.add( 'nativeCallout', mw.KBasePlugin.extend({
		...
		ANDROID_STORE_URL: "https://play.google.com/store/apps/details?id=com.borhan.borhanplayertoolkit",
		IOS_MIME_NAME: "borhanPlayerToolkit://",
		ANDROID_MIME_NAME: "http://borhanplayertoolkit.com",
		APPLINK_URL_PREFIX: "https://borhanplay.appspot.com/play?",
		...
		setup: function(){
			...
			if( !this.getConfig( "iframeUrl" ) ) {
				...
				this.setConfig( "iframeUrl", encodeURI( bWidget.iframeUrls[ this.embedPlayer.id ] + chromecastPluginFlashvar ) );
			}
