...
return array(
	...
	'closedCaptions' => array(
		'description' => 'Reach multi-lingual audience and comply with FCC regulations with Borhan multi-lingual closed captions support.',
	...
	'playlistAPI' => array(
		'description' => 'The Borhan playlist plugin, supports associating multiple clips in sequence.',
		'attributes' => array(
			'autoContinue' => array(
			...
			'kpl0Url' => array(
				'doc' => 'The playlist URL. (can be a Borhan playlist service or MRSS)',
				'type' => 'url'
			),
			'kpl0Id' => array(
				'doc' => "The borhan playlist Id",
				'type' => 'string'
			),
			'kpl0Name' => array(
	...
	'localizationCode' => array(
			'description'=> "Set the language of the Borhan player user interface. Supports language code or <b>auto</b> to take the browser
	...
	'flavorComboControllerScreen' => array(
		'description' => "The Borhan flavor selector plugin.",
	),
...
The playhead reflects segment time as if it was the natural stream length.",
	...
	'logo' => array(
		'description' => "The Borhan custom logo plugin.",
...
'theme' => array(
					...
					'doc' => "<p style='text-align: left'>Allows you to define the URL shared for this player:</p>
						<ul style='text-align: left'>
							<li><b>smart</b> will maximize inline social sharing playback, by using the
								page URL or Borhan URL, and depend on whether opengraph tags are present on the page</li>
	...
	'watermark' => array(
		...
		'description' => "The borhan watermark plugin", // used for tooltip
		...
		'attributes' => array(
			...
			'watermarkPath' => array(
				...
				'initvalue' => 'http://www.borhan.com/content/uiconf/borhan/bmc/appstudio/bdp3/exampleWatermark.png',
	...
	'statistics' => array(
		'description' => 'Use Borhan statistics to
		<a target="_new" href="http://knowledge.borhan.com/creating-and-tracking-analytics-bmc-0">track analytics for the Borhan player.</a>
		Statistics are enabled by default.',
		'attributes' => array(
			'trackEventMonitor' => array(
				'doc' => "Use to audit Borhan events with a named callback function.",
				'type' => 'string'
			)
		)
	),
	...
	'playbackContext' => array(
		'doc' => "The playback context sent to Borhan analytics."
	),
	'originFeature' => array(
		'doc' => "The featureType var sent to Borhan analytics."
	),
	'applicationName' => array(
		'doc' => "For registering the application with Borhan analytics.",
	),
	'userId' => array(
		'doc' => "For associating a userId with Borhan analytics."
	),
	...
	'myExternalResourcesPlugin' => array(
		...
		"attributes" => array(
			'onPageJs1' => array(
				'doc' => "An onPage javascript file is loaded on the client page. More about <a href=\"http://html5video.org/wiki/Borhan_OnPage_Plugins\">onPage plugins</a>",
				'type' => 'url',
			),
			'onPageCss1' => array(
				'doc' => "An onPage CSS file is loaded on the client page. More about <a href=\"http://html5video.org/wiki/Borhan_OnPage_Plugins\">onPage plugins</a>",
				'type' => 'url'
			),
			'iframeHTML5Js1' => array(
				'doc' => "Javascript to be loaded inside the iframe. More about <a href=\"http://html5video.org/wiki/Developing_Borhan_HTML5_Plugins\">html5 iframe plugins</a>",
				'type' => 'url'
			),
			'iframeHTML5Css' => array(
				'doc' => "CSS to be loaded inside the iframe. More about <a href=\"http://html5video.org/wiki/Developing_Borhan_HTML5_Plugins\">html5 iframe plugins</a>",
				'type' => 'url'
			)
		)
	),
	...
	'bumper' => array(
		'description' => "Bumpers, enables a Borhan entry to be displayed before or after the content.",
		"attributes" => array(
			'bumperEntryID' => array(
	...
	'vast' => array(
		...
		'description' => "Borhan player features robust VAST support for prerolls, midrolls, overlays, companions and postrolls",
		"attributes" => array(
			'prerollUrl' => array(
