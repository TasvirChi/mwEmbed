...
( function( mw, $ ) {
		...
		if (embedPlayer.isPluginEnabled("nativeCallout") && !mw.isNativeApp()){
			...
			if (isMseSupported() || (drmConfig.forceDASH && mw.supportSilverlight()) || mw.isNativeApp()) {
				...
				if ( hasDrmSources(drmSources) && !mw.isNativeApp()) {
					...
					var clDashPlayerUrl = embedPlayer.getBorhanConfig( "multiDrm", "clDashPlayerUrl" ) || mw.getMwEmbedPath() + "node_modules/mwEmbed-Dash-Everywhere/video.js";
					var dashJsUrl = embedPlayer.getBorhanConfig( "multiDrm", "dashJsUrl" ) || mw.getMwEmbedPath() + "node_modules/mwEmbed-Dash-Everywhere/cldasheverywhere.min.js";
	...
	function removeNonDrmSources(sources, drmSources, enableHlsAes, embedPlayer){
		...
		embedPlayer.borhanFlavors = drmSources;
	...
	if (bWidget.isIOS() && !Array.prototype.findIndex) {
