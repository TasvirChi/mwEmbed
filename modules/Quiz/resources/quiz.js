(function (mw, $) {
    ...
    mw.PluginManager.add('quiz', mw.KBaseScreen.extend({
        ...
        addBindings: function () {
            ...
            this.bind('BorhanSupport_CuePointReached', function (e, cuePointObj) {
            ...
            this.bind('prePlayAction', function (e, data) {
                ...
                if(_this.getPlayer().firstPlay && !_this.firstPlay){
                    ...
                    _this.enablePlayDuringScreen = false;
                    _this.KIVQModule.checkQBDPReady(function(){
                        _this.ssWelcome();
            ...
            embedPlayer.addJsListener( 'bdpReady', function(){
                _this.KIVQModule.isQBDPReady = true;
                if (embedPlayer.autoplay) {
                    embedPlayer.autoplay = false;
                }
                embedPlayer.removeJsListener( 'bdpReady');
