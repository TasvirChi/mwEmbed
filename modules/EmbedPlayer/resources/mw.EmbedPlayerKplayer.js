		...
		this.getEntryUrl().then(function (srcToPlay) {
				...
				if (_this.isHlsSource(_this.mediaElement.selectedSource)) {
                    ...
                    if(mw.getConfig("hlsLiveSegmentBuffer")) {
                        flashvars.BorhanHLS["liveSegmentBuffer"] = mw.getConfig("hlsLiveSegmentBuffer");
                    }
                    if(mw.getConfig("hlsInitialBufferTime")) {
                        flashvars.BorhanHLS["initialBufferTime"] = mw.getConfig("hlsInitialBufferTime");
                    }
                    if(mw.getConfig("hlsExpandedBufferTime")) {
                        flashvars.BorhanHLS["expandedBufferTime"] = mw.getConfig("hlsExpandedBufferTime");
                    }
                    if(mw.getConfig("hlsMaxBufferTime")) {
                        flashvars.BorhanHLS["maxBufferTime"] = mw.getConfig("hlsMaxBufferTime");
                    }
                    if(mw.getConfig("hlsLogs")) {
                        flashvars.BorhanHLS["sendLogs"] = mw.getConfig("hlsLogs");
