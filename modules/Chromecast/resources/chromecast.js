( function( mw, $ ) {"use strict";
	...
	mw.PluginManager.add( 'chromecast', mw.KBaseComponent.extend({
		...
		defaultConfig: {
			...
			'visible': false,
			'align': "right",
			'applicationID': "FFCC6D19", // DB6462E9: Chromecast default receiver, FFCC6D19: Borhan custom receiver supporting DRM, HLS and smooth streaming
			'showTooltip': true,
		...
		onRequestSessionSuccess: function(e) {
			...
			if (this.getConfig("useBorhanPlayer") === true){
				this.sendMessage({'type': 'embed', 'publisherID': this.embedPlayer.bwidgetid.substr(1), 'uiconfID': this.embedPlayer.kuiconfid, 'entryID': this.embedPlayer.kentryid, 'debugBorhanPlayer': this.getConfig("debugBorhanPlayer")});
				this.embedPlayer.showErrorMsg(
					{'title':'Chromecast Player',
