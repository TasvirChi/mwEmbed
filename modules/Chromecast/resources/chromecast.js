	...
	mw.PluginManager.add( 'chromecast', mw.KBaseComponent.extend({
		...
		onRequestSessionSuccess: function(e) {
			...
			if (this.getConfig("useBorhanPlayer") === true){
				...
				this.sendMessage({'type': 'embed', 'publisherID': this.embedPlayer.bwidgetid.substr(1), 'uiconfID': this.embedPlayer.kuiconfid, 'entryID': this.embedPlayer.kentryid, 'debugBorhanPlayer': this.getConfig("debugBorhanPlayer"), 'flashVars': flashVars});
				this.embedPlayer.showErrorMsg(
					{'title':'Chromecast Player',
