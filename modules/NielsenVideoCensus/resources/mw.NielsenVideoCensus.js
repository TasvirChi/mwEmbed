...
* https://portal.borhan.com/product/Shared%20Documents/Solution%20Architects/_Generic%20PRDs/Nielsen/BDP%20Nielsen%20Video%20Census%20Plugin%20PRD.docx
*/
...
mw.NielsenVideoCensus.prototype = {
	...
	*/
	addPlayerBindings: function(){
		...
		_this.embedPlayer.bindHelper('BorhanSupport_AdOpportunity' + _this.bindPostfix, function(){
			inMidroll = true;
		});
	...
	getConfig: function( key ){
		return this.embedPlayer.getBorhanConfig( 'nielsenVideoCensus', key );
	}
}